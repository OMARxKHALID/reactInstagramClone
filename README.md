...
- **Feed**: Display posts from followed users in a scrollable feed format.
- **Stories**: Showcase user stories in a visually appealing carousel-like interface.
- **User Profiles**: View and interact with user profiles, including bio, profile picture, and follower/following counts.
