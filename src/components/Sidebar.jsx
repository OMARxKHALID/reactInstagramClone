...
const SideBar = () => {
  ...
  const links = [
    ...
    { name: "Explore", route: "#", IconLine: MdOutlineExplore, IconFilled: MdExplore },
    { name: "Reels", route: "#", IconLine: MdOutlineVideoLibrary, IconFilled: MdVideoLibrary },
    { name: "Search", route: "#", IconLine: AiOutlineSearch, IconFilled: ImSearch },
    { name: "Create", route: "#", IconLine: FiPlusSquare, IconFilled: BsFillPlusSquareFill },
    { name: "Notifications", route: "#", IconLine: FiHeart, IconFilled: FiHeart },
  ...
  return (
    <div className="fixed left-4 h-full border-r-[1px] border-solid border-gray-300" style={{ width: "200px" }}>
      <div className="flex flex-col mt-6 mr-4 h-full items-start">
          ...
          {links.map((link, index) => {
            ...
            return (
              <Link key={index} to={link.route}>
                <button className="p-2 mr-3 rounded-md hover:bg-gray-200 w-full flex items-center space-x-4 mt-auto mb-4" style={{ width: "200px" }}>
                  <Icon size="25px" />
                  <div>{link.name}</div>
                </button>
              </Link>
        ...
        <Link to="#">
          <button className="p-2 mt-[300px] mr-3 rounded-md hover:bg-gray-200 w-full flex items-center space-x-4 mb-4" style={{ width: "200px" }}>
            <FiLogOut size="25px" />
